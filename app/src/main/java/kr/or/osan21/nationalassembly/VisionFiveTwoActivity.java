...
public class VisionFiveTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //이미지 적용 (본문내용+이미지)
        ImageView img = (ImageView)findViewById(R.id.vision_five_two_img);
        ImageView content = (ImageView)findViewById(R.id.vision_five_two_content);
        ...
        Glide.with(this)
                .load(R.drawable.vision_five_two)
                .override(width, height)
                .centerCrop()
                .into(img);

        Glide.with(this)
                .load(R.drawable.vision_five_content_02)
                .fitCenter()
                .into(content);
